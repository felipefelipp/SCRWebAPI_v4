...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<PerguntaSelecionadaPacienteModel> PerguntaSelecionadaPaciente { get; set; }
    public DbSet<RespostaModel> Respostas { get; set; }
    public DbSet<RespostaSelecionadaPacienteModel> RespostaSelecionadaPaciente { get; set; }
